...
public class FundasLateral extends Fotbalist implements FundasInterface {
    public FundasLateral(String nume, String prenume, String oras, String nationalitate, Integer varsta, Double rating, String pozitieTeren, String club, String nationala, Integer nrTricou, Boolean esteCapitan, Boolean esteTitular) {
