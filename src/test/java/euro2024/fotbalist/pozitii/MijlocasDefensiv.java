...
public class MijlocasDefensiv extends Fotbalist implements MijlocasInterface, FundasInterface {
    ...
    public MijlocasDefensiv(String nume, String prenume, String oras, String nationalitate, Integer varsta, Double rating, String pozitieTeren, String club, String nationala, Integer nrTricou, Boolean esteCapitan, Boolean esteTitular) {
