...
// cat am de platit impozit in functie de anul masini
// varibila globala an
// afisareImpozit(Integer parametru)
// if older <2015 then sout 200lei else if newer >2015 =2020 then sout 100lei else >=2020 then sout 50lei
// sout proprietarul are de platit suma

public class TemaMasini {
